        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">Admin ParkIn</h2>
                    </a>
                </div>
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                           <input class="form-control" type="text" placeholder="Masukkan Email" required="true" name="username">
                        </div>
                        <div class="form-group">
